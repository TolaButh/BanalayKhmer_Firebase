...
import tolabuth.example.banalaybook.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvLoginSingup.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.btnLoginSytem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                validateData();
            }
    ...
    private void validateData() {
        //before login , lets do some data validate
        //getData
        ...
        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
            ...
            Toast.makeText(LoginActivity.this, "Invalide email pattern ....", Toast.LENGTH_SHORT).show();
    ...
    private void loginUser() {
        ...
        firebaseAuth.signInWithEmailAndPassword(email, password)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    //login successfully, check if user or admin
                        checkUser();
                    }
                })
